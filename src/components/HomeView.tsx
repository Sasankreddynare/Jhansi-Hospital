        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="max-w-4xl space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-sans tracking-tight font-extrabold text-slate-900 dark:text-white leading-tight">
                Advanced <span className="text-blue-600 dark:text-teal-400">Multi-Speciality Care</span> & Specialist Rehabilitation
              </h1>

              <p className="text-slate-600 dark:text-slate-350 text-xs md:text-sm md:text-base leading-relaxed max-w-3xl mx-auto font-medium">
                Sri Jhansi Hospital (Ortho & Neuro Rehabilitation Center) provides highly coordinated comprehensive trauma support, bone fracture reductions, neurosurgeries, and clinical physical therapies. We focus on transparent clinical outcomes designed to restore health and independence for the Piler community.
              </p>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
                <a 
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 bg-[#00a884] hover:bg-[#008f72] text-white font-extrabold text-xs uppercase tracking-wider rounded-xl text-center transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg active:scale-98 flex-1"
                >
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 bg-slate-900 text-white border border-slate-700 dark:border-blue-900/60 font-bold text-xs uppercase tracking-wider rounded-xl text-center transition-all hover:bg-slate-800 flex items-center justify-center gap-1.5 flex-1 cursor-pointer"
                >
            ...
            {/* Cinematic Centered Hospital Tour Video Player */}
            <div className="w-full max-w-5xl relative mt-8">
              <div className="absolute inset-4 bg-gradient-to-tr from-blue-600 to-teal-500 rounded-3xl opacity-10 blur-xl pointer-events-none"></div>
