            ...
            <div className="max-w-4xl space-y-6">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-6 py-3.5 bg-slate-900 hover:bg-slate-800 text-white border border-slate-700 dark:border-blue-900/60 font-extrabold text-xs uppercase tracking-wider rounded-xl text-center transition-all flex items-center justify-center gap-1.5 flex-1 cursor-pointer whitespace-nowrap"
                >
